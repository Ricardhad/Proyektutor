...
public class Fruit extends Entity {
    public Fruit(GamePanel gp){
        ...
        public void getPlayerImage() {
            try {
              up1 =  ImageIO.read(getClass().getResourceAsStream("/tomb_sprite/tomb_fruit0.png"));
              up2 =  ImageIO.read(getClass().getResourceAsStream("/tomb_sprite/tomb_fruit1.png"));
              down1 =  ImageIO.read(getClass().getResourceAsStream("/tomb_sprite/tomb_fruit0.png"));
              down2 =  ImageIO.read(getClass().getResourceAsStream("/tomb_sprite/tomb_fruit1.png"));
